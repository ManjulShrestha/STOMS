 ...
 */
@Dependent
public class UserTypeDao extends PersistenceManager<UserType, Serializable> {
	@SuppressWarnings("unchecked")
	public List<UserType> getUserTypes(SearchCriteria searchCriteria){		
		StringBuilder strBuilder = new StringBuilder();
		strBuilder.append("SELECT entity FROM UserType entity where 1=1");			
